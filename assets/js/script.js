...
$SearchBtn.on('click', function (event) {
    ...
    // Fetch Request for Current Cities 
    fetch('https://api.openweathermap.org/data/2.5/weather?q=' + Input.value + '&appid=0591d2d80fcb3a6ed1994a57957ddc6a')
    ...
    fetch('https://api.openweathermap.org/data/2.5/forecast?q=' + Input.value + '&units=imperial&appid=0591d2d80fcb3a6ed1994a57957ddc6a')
        .then(response => response.json())
        .then(data => {
            console.log(data);
...
$('#BtnSpots').on('click', '#Relook' , function (event) { 
    ...
    event.stopImmediatePropagation();
     console.log("Clicked");
     var city = $(this).text();
    fetch('https://api.openweathermap.org/data/2.5/weather?q=' + city + '&appid=0591d2d80fcb3a6ed1994a57957ddc6a')
    .then(response => response.json())
    .then(data => {
        var CityValue = data['name'];
        var TemperValue = data['main']['temp'];
...
fetch('https://api.openweathermap.org/data/2.5/forecast?q=' + city + '&units=imperial&appid=0591d2d80fcb3a6ed1994a57957ddc6a')
    .then(response => response.json())
    .then(data => {
        console.log(data);
            var Icon1 = 'https://openweathermap.org/img/w/' + data.list[0].weather[0].icon+ '.png';
